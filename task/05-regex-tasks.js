...
function getRegexForIPv4() {
   let groupRegExp = new RegExp('(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|0[0-9][0-9]|[1-9]?[0-9])');
   return new RegExp('^' + groupRegExp.source + '\\.' + groupRegExp.source + '\\.' + groupRegExp.source + '\\.' + groupRegExp.source + '$');
}
